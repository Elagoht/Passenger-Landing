...
const DocsNavBarItem: FC<IDocsNavBarItemProps> = ({
  ...
  <Link href={href} >
    <li className={classNames({
      "hover:bg-tuatara-100 dark:hover:bg-tuatara-900 transition-all duration-100 relative pl-10 pr-2 py-1": true,
      ...
      "after:block after:h-2 after:w-2 after:bg-current after:absolute after:top-1/2 after:-translate-y-1/2 after:left-4 after:rounded-full after:ring-4 after:ring-tuatara-50 dark:after:ring-tuatara-950": true,
      "text-creamcan-500": active,
      "text-tuatara-500": !active
    })}>
      {title}
    </li>
  </Link>
