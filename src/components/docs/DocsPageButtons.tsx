...
const DocsPageButtons: FC<IDocsPageButtonsProps> = ({ next, prev }) =>
  <div className="flex gap-4 items-center justify-center flex-wrap w-full">
    {prev &&
      <Link
        href={prev.href}
        className="no-underline flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-tuatara-500 flex-1 text-center relative overflow-hidden
